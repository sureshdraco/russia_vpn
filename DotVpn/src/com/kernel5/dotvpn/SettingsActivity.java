...
public class SettingsActivity extends Activity {
  ...
  /*
      ...
      Runnable mGetUser = new Runnable() {
          ...
          public void run() {
            ...
            try {
            	...
            	String mUsername = SettingsActivity.this.mPrefs.getString(getString(R.string.SettingsKeyAccountName), "...");
            	
               InfoRequest request = new InfoRequest();
               request.token = SettingsActivity.this.mPrefs.getString( Constants.OAUTH_TOKEN, "" );
               ...
               if ( response.code == 0 )
               {
                  ...
                  String epass = SettingsActivity.this.mPrefs.getString( Constants.BAUTH_TOKEN, "" );
                  String ckey = pemail[0] + "123456789101112";
                  ckey = ckey.substring( 0, 16 );
                  DESEncrypt decoder = new DESEncrypt( ckey );
                  SettingsActivity.this.mPassword = decoder.decrypt( epass );
                  
                  if ( ! mUsername.equals(response.email)) {
                	  
                	  SharedPreferences.Editor prefs_editor = SettingsActivity.this.mPrefs.edit();
                	  prefs_editor.putString(getString(R.string.SettingsKeyAccountName), response.email);
                	  prefs_editor.commit();
                  }
               }
    ...
    public void onResume() {
      super.onResume();
      LocalBroadcastManager.getInstance(this).registerReceiver(this.logout_listener,
          new IntentFilter("com.kernel5.dotvpn.ACTION_LOGOUT"));
    }
    
    public void closeActivityAndReturn(View view) {
//    	Intent intent = new Intent(SettingsActivity.this, ConnectActivity.class);
//    	startActivity( intent );
    ...
    protected void onPause() {
    	LocalBroadcastManager.getInstance(this).unregisterReceiver(this.logout_listener);
    	super.onPause();
    } 
